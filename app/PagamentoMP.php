<?php 
 ...
 class PagamentoMP{
     ...
     private $client_id = "2812382661296607";
     private $client_secret = "591evzmnEtmH0oDoZLwduN2dxRMXqIlV";
    ...
    $preference_data = array(   
            ...
            "back_urls" => array(
               ...
               "failure" => $url."notifica.php?success",
               "pending" => $url."notifica.php?success"
             ),
   ...
   public function Retorno($id , $conn){
     ...
     $ref = $payment_info["response"]["collection"]["external_reference"];
      ...
      $query = mysqli_query($conn,"UPDATE faturas SET status='$status' , forma='$forma', setado='sim' WHERE referencia='$ref'");
      if($query){
         return true;
      }
