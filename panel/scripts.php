    ...
    <div class="scripts">
      ...
      <div class="container">
        ...
        while($row = mysqli_fetch_array($query)){
          ...
          <div class="col-md-3">
            <div class="card">
              <p class="name"><?php echo $row['script'] ?></p>
            <p class="price">Pago</p>
            <i class="fas fa-box-open"></i>
            <?php 
            $query3 = "SELECT * FROM produtos WHERE id='$idsc'";
            $result3 = mysqli_query($conexao, $query3);
            while($row2 = mysqli_fetch_array($result3)){
              echo "<a href='".$row2['arquivo']."' class='btn btn-logs'><i class='fas fa-download'></i> Download</a>";
            }
            ?>
            </div>
          </div>
