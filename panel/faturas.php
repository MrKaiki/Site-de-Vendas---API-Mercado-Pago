      ...
      <div class="container">
        <div class="row">
          <table class="table">
            ...
            <tbody>
            <?php
        $query = mysqli_query($conexao, "SELECT * FROM faturas WHERE cliente='$email'");
        while($row = mysqli_fetch_array($query)){
          ?>
              ...
              <td><span class="pendente"><?php echo $row['status'] ?></span></td>
                  <?php }else{
                    ?>
                    <td><span class="aprovado"><?php echo $row['status'] ?></span></td>
                  <?php } ?>
