...
if(!$_SESSION['admin']) {
	header('Location: http://localhost/MetaCodes/clientarea/login.php');
	exit();
}
        ...
        while($row = mysqli_fetch_array($query)){
          ...
          ?>
                  <tr>
                    ...
                    <?php $query2 = mysqli_query($conexao, "SELECT * FROM licenses WHERE idclient='$id'");
